...
export class ReactPanel {
	...
	public static createOrShow(extensionPath: string, extensionUri: vscode.Uri) {
		...
		if (ReactPanel.currentPanel) {
			...
			ReactPanel.currentPanel = new ReactPanel(extensionPath, extensionUri, column || vscode.ViewColumn.One);
		}
	}

	private constructor(extensionPath: string, extensionUri: vscode.Uri, column: vscode.ViewColumn) {
