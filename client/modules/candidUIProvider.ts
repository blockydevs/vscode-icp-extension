...
export class CandidUIProvider {
	...
	getWebviewContent(canisterCandidUI: any, canisterId: any) : string {
        return `<!DOCTYPE html>
                    <html lang="en"">
                    <head>
                        <meta charset="UTF-8">
                    ...
                    <body>
                        <iframe src="http://localhost:${CandidUIProvider.WEBVIEW_PORT}/?canisterId=${canisterCandidUI}&id=${canisterId}"></iframe>
                    </body>
                    </html>`
    }
